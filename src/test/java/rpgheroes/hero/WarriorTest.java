...
class WarriorTest {
    ...
    private final Armor.ArmorType invalidArmorType = Armor.ArmorType.leather;
    ...
    void damage_shouldCalculateCorrectly_weaponless() {
        ...
        int damagingAttribute = startAttributes.getStrength();
    ...
    void display_should_returnExpectedString() {
        //using the class-based damaging attribute
        double damage = calculateDamage(weaponlessDamage, startAttributes.getStrength());
