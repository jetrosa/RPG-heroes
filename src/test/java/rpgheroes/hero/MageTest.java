...
class MageTest {
    ...
    private final Armor.ArmorType validArmorType = Armor.ArmorType.cloth;
    private final Armor.ArmorType invalidArmorType = Armor.ArmorType.plate;
    private final Weapon.WeaponType validWeaponType = Weapon.WeaponType.staff;
    private final Weapon.WeaponType invalidWeaponType = Weapon.WeaponType.sword;
    private final HeroAttribute startAttributes = new HeroAttribute(1, 1, 8);
    ...
    void damage_shouldCalculateCorrectly_weaponless() {
        ...
        int damagingAttribute = startAttributes.getIntelligence();
    ...
    void display_should_returnExpectedString() {
        //using the class-based damaging attribute
        double damage = calculateDamage(weaponlessDamage, startAttributes.getIntelligence());
